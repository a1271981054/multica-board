...
func buildQuickCreatePrompt(task Task) string {
	...
	b.WriteString("  Mode tags: if the user input contains any `[/X](slash://skill/mode:X)` mode tags (for example `[/目标模式](slash://skill/mode:目标模式)`), preserve them VERBATIM as the final line(s) of the description. They are routing metadata the platform re-reads on future runs, not content to summarize or strip.\n\n")
