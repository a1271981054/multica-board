...
type AppConfig struct {
	...
	AutoLoginEmail string `json:"auto_login_email,omitempty"`
	AutoLoginCode  string `json:"auto_login_code,omitempty"`
}
...
func (h *Handler) GetConfig(w http.ResponseWriter, r *http.Request) {
	...
	if os.Getenv("MULTICA_BOARD_AUTO_LOGIN") == "true" {
		...
		config.AutoLoginCode = os.Getenv("MULTICA_DEV_VERIFICATION_CODE")
	}
